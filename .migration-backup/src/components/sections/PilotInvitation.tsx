...
export function PilotInvitation() {
  const { pilot, whatsapp } = course;

  return (
    <section id="get-started" aria-labelledby="pilot-heading" className="bg-gb-yellow py-16 sm:py-24">
      <Container>
        <div className="mx-auto max-w-3xl text-center">
          ...
          <div className="mt-8 flex flex-col items-center justify-center gap-3 sm:flex-row">
            <WhatsAppButton location="pilot" size="lg">
              {pilot.cta}
            </WhatsAppButton>
            <MailButton subject="pilot" location="pilot_email" variant="plum" size="lg">
              {course.email.cta}
            </MailButton>
          </div>
          <p className="mt-3 text-sm">
            <WhatsAppButton kind="callback" location="pilot_callback" variant="link" size="bare" className="text-sm">
